    ...
    */
    ...
    function eXcell_Pasw(cell){if (cell){this.cell = cell;this.grid = this.cell.parentNode.grid};this.edit = function(){this.cell.innerHTML = "";this.cell.atag="INPUT";this.val = this.getValue();this.obj = document.createElement(this.cell.atag);this.obj.style.height = (this.cell.offsetHeight-(_isIE?6:4))+"px";this.obj.className="dhx_combo_edit";this.obj.type = "password";this.obj.wrap = "soft";this.obj.style.textAlign = this.cell.align;this.obj.onclick = function(e){(e||event).cancelBubble = true};this.obj.onmousedown = function(e){(e||event).cancelBubble = true};this.obj.value = this.cell._rval
 this.cell.appendChild(this.obj);if (_isFF){this.obj.style.overflow="visible";if ((this.grid.multiLine)&&(this.obj.offsetHeight>=18)&&(this.obj.offsetHeight<40)){this.obj.style.height="36px";this.obj.style.overflow="scroll"}};this.obj.onselectstart=function(e){if (!e)e=event;e.cancelBubble=true;return true};this.obj.focus()
 this.obj.focus()
 
 
 
 };this.getValue = function(){return this.cell._rval};this.setValue = function(val){var str = "*****";this.cell.innerHTML = str;this.cell._rval=val};this.detach = function(){this.setValue(this.obj.value);return this.val!=this.getValue()}};
    ...
    */
    ...
    function eXcell_date(cell){
            ...
            this.edit=function(){
                    ...
                    this.val=this.getValue();
                    this.obj=document.createElement(this.cell.atag);
                    cal= new dhtmlXCalendarObject(this.obj);
                    cal.hideTime();
                    ...
                    $(this.obj).dateEntry({dateFormat: "dmy/",spinnerImage: ""});
                    this.obj.focus()
            }
            this.getValue=function(){
                    if ((this.cell.firstChild)&&((this.cell.atag)&&(this.cell.firstChild.tagName == this.cell.atag)))
    ...
    eXcell_date.prototype=new eXcell_ed;
    
      /**
    *       @desc: simple text datetime editor
    *       @returns: dhtmlxGrid cell editor object
    *       @type: public
    */
    var cal;
    function eXcell_datetime(cell){
            ...
            this.edit=function(){
                    ...
                    $(this.obj).datetimeEntry({datetimeFormat: 'D/O/Y H:M',spinnerImage: ""});
                    this.obj.focus()
            }
            this.getValue=function(){
                    if ((this.cell.firstChild)&&((this.cell.atag)&&(this.cell.firstChild.tagName == this.cell.atag)))
    ...
    eXcell_datetime.prototype=new eXcell_ed;
      /**
    *       @desc: simple text time editor
    *       @returns: dhtmlxGrid cell editor object
    *       @type: public
    */
    function eXcell_time(cell){
            ...
            this.edit=function(){
                    ...
                    $(this.obj).timeEntry({show24Hours: true, showSeconds: false,spinnerImage: ""});
                    this.obj.focus()
            }
            this.getValue=function(){
                    if ((this.cell.firstChild)&&((this.cell.atag)&&(this.cell.firstChild.tagName == this.cell.atag)))
    ...
    eXcell_time.prototype=new eXcell_ed;
      /**
    *       @desc: simple text nummeric editor
    *       @returns: dhtmlxGrid cell editor object
    *       @type: public
    */
    function eXcell_nummeric(cell){
            if (cell){
                    this.cell=cell;
                    this.grid=this.cell.parentNode.grid;
            }
            this.edit=function(){
                    ...
                    $(this.obj).autoNumeric({aPad: false,mRound:'S'});
                    this.obj.focus()
            }
            this.getValue=function(){
                if ((this.cell.firstChild)&&(this.cell.firstChild.tagName == "TEXTAREA"))
    ...
    eXcell_nummeric.prototype=new eXcell;
    eXcell_nummeric.prototype.setValue=function(val)
    {
        ...
        {
            this.cell._clearCell=false;         
            this.setCValue(this.grid._aplNF(val.toString()._dhx_trim().replace(/\,/g,''), this.cell._cellIndex));
        }
    };
      /**
    *       @desc: simple text nummeric to text char editor
    *       @returns: dhtmlxGrid cell editor object
    *       @type: public
    */
    function eXcell_numchu(cell){
            if (cell){
                    this.cell=cell;
                    this.grid=this.cell.parentNode.grid;
            }
            this.edit=function(){
                    ...
                    $(this.obj).autoNumeric({aPad: false});
                    this.obj.focus()
            }
            this.getValue=function(){
                if ((this.cell.firstChild)&&(this.cell.firstChild.tagName == "TEXTAREA"))
    ...
    eXcell_numchu.prototype=new eXcell;
    eXcell_numchu.prototype.setValue=function(val)
    {
        if (!val||val.toString()._dhx_trim() == "")
        {
            this.cell._clearCell=true;
            return this.setCValue("&nbsp;",0)
             ...
             this.cell._clearCell=false;        
        this.setCValue(this.grid._aplNF(val.replace(/\,/g,''), this.cell._cellIndex))
    };
   ...
   function eXcell_co(cell){   
        ...
        this.edit=function(){   
            ...
            this.obj.onkeyup=function(e){   
                ...
                for (var i = 0; i < c.length; i++)   
                    if (c[i].text.toLowerCase().indexOf(val.toLowerCase()) != -1)  
            ...
            this.obj.onkeydown=function(e){   
                ...
                if(e.keyCode==13||e.keyCode==9)
                {
                    var c = editor_obj.list.options;   
                    for (var i = 0; i < c.length; i++)   
                    if (c[i].text.toLowerCase().indexOf(this.value.toLowerCase()) != -1)  
                    { 
                          this.value=c[i].text;  
                          break;
                    }
            ...
            // var my_sid=guid(),my_w=this.cell.offsetWidth+"px",my_t=arPos[1]+this.cell.offsetHeight+"px",my_l=arPos[0]+"px";
            var my_sid=guid(),my_w=this.cell.offsetWidth+"px",my_h=this.cell.offsetHeight+2+"px",my_t=arPos[1]+"px",my_l=arPos[0]+"px";
            this.list.setAttribute("id",my_sid);
            this.list.setAttribute("class", 'selectpicker gridcelltype');   
            this.list.style.width=my_w;   
            this.list.style.left=my_l;                       //arPos[0]   
            this.list.style.top=my_t; //arPos[1]+this.cell.offsetHeight;   
            ...
            $("#"+my_sid).selectpicker({liveSearch: true,noneResultsText: 'Không có kết quả {0}'}).data("selectpicker").$searchbox.focus(); 
            $("#"+my_sid).on('change', function(e){
                    var ev = e||window.event;
                    var cell = ev.target||ev.srcElement  
                   if (cell.tagName == "OPTION")
                   cell=cell.parentNode;
            ...
            document.querySelector('[data-id="'+my_sid+'"]').parentNode.querySelector('input').onkeydown=function(e){ 
                    e=e||window.event;   
            ...
            $("#"+my_sid).val(this.val);
            $(document.querySelector('[data-id="'+my_sid+'"]')).addClass('invisible');
            $(document.querySelector('[data-id="'+my_sid+'"]').parentNode).addClass('open');
            document.querySelector('[data-id="'+my_sid+'"]').parentNode.setAttribute("style","width:"+my_w+";left:"+my_l+";top:"+my_t+";");
            document.querySelector('[data-id="'+my_sid+'"]').parentNode.querySelector('input').setAttribute("style","width:"+my_w+";height:"+my_h);
            this.list.size="6";   
            this.cstate=1;   
            ...
            if ((!_isFF)||(this.editable)){  
                    document.querySelector('[data-id="'+my_sid+'"]').parentNode.querySelector('input').focus();  
            //     this.obj.focus();   
            //     this.obj.focus();   
            }   
            ...
            if (!this.editable){   
                ...
                $("#"+my_sid).selectpicker().data("selectpicker").$searchbox.focus();
                document.querySelector('[data-id="'+my_sid+'"]').parentNode.querySelector('input').focus(); 
        ...
        this.detach=function(){   
            ...
            if (this.list.parentNode)
            {
                    ...
                    var my_sid=this.list.id;
                    $("#"+my_sid).selectpicker('destroy');
                    document.querySelector('[data-id="'+my_sid+'"]').parentNode.remove();
            }  
...
eXcell_conew.prototype=new eXcell;   
eXcell_conew.prototype.getText=function(){   
    return this.cell.innerHTML;   
}   
eXcell_conew.prototype.setValue=function(val){   
    if (typeof (val) == "object"){   
        var optCol = this.grid.xmlLoader.doXPath("./option", val);   
...
function eXcell_coro(cell){   
    this.base=eXcell_conew;   
    this.base(cell)   
    this.editable=false;   
}   
eXcell_coro.prototype=new eXcell_conew;   
   
function eXcell_cotxt(cell){   
    this.base=eXcell_conew;   
    this.base(cell)   
}   
eXcell_cotxt.prototype=new eXcell_conew;   
...
eXcell_corotxt.prototype=new eXcell_cotxt;   
    ...
    eXcell_codis.prototype=new eXcell_coro;
    
    function eXcell_edt(cell){
            this.base=eXcell_edtxt;
            this.base(cell)
            this.editable=false;
    }
    eXcell_edt.prototype=new eXcell_edtxt;
    
    function eXcell_code264(cell){
            this.base=eXcell_ed;
            this.base(cell)
            this.editable=false;
    }
    eXcell_code264.prototype=new eXcell_ed;
    
     function eXcell_code64str(cell){
            this.base=eXcell_ed;
            this.base(cell)
            this.editable=false;
    }
    eXcell_code64str.prototype=new eXcell_ed;
    //#}
    ...
    function eXcell_cp(cell){
        ...
        this.obj.wrap="soft";
            //this.obj.style.textAlign=this.cell.style.textAlign;
                    ...
                    this.obj.wrap="soft";
                    var arPos = this.grid.getPosition(this.cell); //,this.grid.objBox
                    //var arPos = this.grid.objBox.getPosition(this.cell);
            ...
            this.detach=function(){
                    ...
                    //        document.body.removeChild(this.obj);
                      this.grid.objBox.removeChild(this.obj);
    ...
    */
      function eXcell_img(cell){
            ...
            this.getValue=function(){
                     return escape(this.cell.innerHTML.toString()._dhx_trim());
            }      
    }
    ...
    eXcell_img.prototype.setValue=function(val)
    {
        ...
        {
            this.cell._clearCell=true;
            return this.setCValue("<img class='cssUpload' style='display:block;background-color:#CCCCCC;border:#000000 thin;height:inherit;width:inherit;min-width:38px;min-height:38px' onMouseMove='r_cid=\""+this.cell.parentNode.idd+"\";c_cid=\""+this.cell._cellIndex+"\";eventControl();' id='up"+this.cell._cellIndex+"_"+this.cell.parentNode.idd+"'/>");
        }
        else
        {
            this.cell._clearCell=false;
            this.setCValue(unescape(val));
        }
    };
    //#}
    
    //#file_excell:04062008{
    /**
    *       @desc: file editor
    *       @returns: dhtmlxGrid cell editor object
    *       @type: public
   ...
   function eXcell_file(cell){
    ...
    eXcell_file.prototype.setValue=function(val)
    {
        if (!val||val.toString()._dhx_trim() == "")
        {
            this.cell._clearCell=true;
            return this.setCValue("<a class='cssUpload' style='display:block;background-color:#CCCCCC;border:#000000 thin;height:inherit;width:inherit;min-width:38px;min-height:38px;' onMouseMove='r_cid=\""+this.cell.parentNode.idd+"\";c_cid=\""+this.cell._cellIndex+"\";eventControl();' id='up"+this.cell._cellIndex+"_"+this.cell.parentNode.idd+"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>");
        }
        else
        {
            this.cell._clearCell=false;
    ...
    */
    ...
    function eXcell_co_multicolumn(cell){ //the eXcell name is defined here
    ...
    eXcell_co_multicolumn.prototype = new eXcell;
