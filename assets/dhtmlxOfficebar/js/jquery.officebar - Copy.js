...
; (function($) {
    ...
    $.buildOfficeBar = function(object, options) {
        ...
        function removeTab(vari){
            // alert(vari.parent().attr('class'));
            if(vari.parents(".thirdmenu").attr('class').indexOf("current")==-1)
                alert(vari.parents(".officetab").css('display','none'));
        }   
...
setTimeout(function() { $(".current>a").click();}, 100);
